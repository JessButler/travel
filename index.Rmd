...
## Travel and Vulnerability in Grampian
...
car <- read_csv(here("data", "SNS Data Zone 2011 blk", "KS404SC.csv")) %>% 
  clean_names()
...
### Where do people who take transit to work live?
...
aberdeen_sf %>%
  ...
  mapview(
   ...
   layer.name = "take transit (%)",
   alpha.regions = 0.8)
```

<br></br>

### Which neighbourhoods have the most people taking transit to work?
<br></br>
```{r, echo = F}
grampian %>%
  filter(Council_area == "Aberdeen City") %>%
...
### Where do people have to travel far to work without a car?
Mouseover points for area names
